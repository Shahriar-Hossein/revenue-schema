...
$schema = array(
	...
	'properties' => array(
		...
		// if required, checkbox will be checked and disabled.
		'main_products_required_enabled'                             => array(
			'description' => __( 'Main products required enabled', 'revenue' ),
			'type'        => 'boolean',
			'default'     => false,
			'context'     => array( 'view', 'edit' ),
		),
		...
		'suggested_products' => array(
			'description' => __( 'Frequently bought together suggestions', 'revenue' ),
			'type'        => 'array',
			'context'     => array( 'view', 'edit' ),
			'items'       => array(
				'oneOf' => array(
					...
					array(
						'type' => 'object',
						'required' => array( 'type', 'products' ),
						'properties' => array(
							'type' => array(
								'type' => 'string',
								'enum' => array( 'specific_products' ),
								'context' => array( 'view', 'edit' ),
							),
							'products' => array(
								'description' => __( 'List of specific products with discounts and quantities', 'revenue' ),
								'type' => 'array',
								'items' => $base_product_schema,
							),
						),
