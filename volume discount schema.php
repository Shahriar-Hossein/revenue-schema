...
$upsell_extra_product_schema = array(
    'type'       => 'object',
    'required'   => array(
        'extra_product_type',
        'product_id',
    ...
    'context'    => $context,
    'properties' => array(
        'extra_product_type' => array(
            'description' => __('Type of extra product', 'revenue'),
            'type'        => 'string',
            'enum'        => array( 'upsell' ),
            'context'     => $context,
        ),
...
$free_product_extra_schema = array(
    'type'       => 'object',
    'required'   => array( 'extra_product_type', 'product_id', 'product_name', 'quantity' ),
    'context'    => $context,
    'properties' => array(
        'extra_product_type' => array(
            'description' => __('Type of extra product', 'revenue'),
...
$extra_product_schema = array(
    'type'       => 'object',
    'context'    => $context,
    'oneOf'      => array(
        $upsell_extra_product_schema,
        $free_product_extra_schema,
    ),
);

$volume_discount_tier_common_properties = array(
    'title' => array(
        'description' => __('Title for this tier', 'revenue'),
        'type'        => 'string',
        'context'     => $context,
    ),
    'subtitle' => array(
        'description' => __('Subtitle for this tier', 'revenue'),
        'type'        => 'string',
        'context'     => $context,
    ),
    'badge' => array(
        'description' => __('Badge text for this tier', 'revenue'),
        'type'        => 'string',
        'context'     => $context,
    ),
    'selected_by_default' => array(
        'description' => __('Whether this tier is selected by default', 'revenue'),
        'type'        => 'boolean',
        'default'     => false,
        'context'     => $context,
    ),
    'display_product_image' => array(
        'description' => __('Display product images for this tier', 'revenue'),
        'type'        => 'boolean',
        'default'     => false,
        'context'     => $context,
    ),
    'custom_image_id' => array(
        'description' => __('Custom image ID for this tier', 'revenue'),
        'type'        => 'integer',
        'context'     => $context,
    ),
    'free_shipping' => array(
        'description' => __('Enable free shipping for this tier', 'revenue'),
        'type'        => 'boolean',
        'default'     => false,
        'context'     => $context,
    ),
    'extra_products' => array(
        'description' => __('List of extra products for this tier', 'revenue'),
        'type'        => 'array',
        'context'     => $context,
        'items'       => $extra_product_schema,
    ),
);
        ...
        'tiers' => array(
            ...
            'items'       => array(
                ...
                'properties' => array_merge(
                    ...
                    $volume_discount_tier_common_properties
                ),
                'oneOf' => array(
                    array(
                        'properties' => array(
                            'tier_type' => array(
                                ...
                                'type'        => 'string',
                                'enum'        => array( 'buy_x_get_y' ),
                                'context'     => array( 'view', 'edit' ),
                            ),
                            'x_qty' => array(
                                'description' => __(
                                    'Required buy quantity for this tier',
                                    'revenue'
                                ),
                                'type'        => 'integer',
                                'minimum'     => 1,
                        ...
                        'required' => array( 'tier_type', 'x_qty', 'y_qty' ),
                    ),
                    array(
                        'properties' => array(
                            'tier_type' => array(
